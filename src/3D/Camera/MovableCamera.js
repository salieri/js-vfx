...
define( [ 'Core/Point2D', '3D/Camera/Camera', 'Core/Point3D', 'Core/Vector3D' ],

function( Point2D, Camera, Point3D, Vector3D )
{
	'use strict';
	...
	MovableCamera.prototype = new Camera();
