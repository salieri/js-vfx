define( [ 'Core/Point2D', 'Core/Color' ],

function( Point2D, Color )
{
	'use strict';
	...
	return {
		 ...
		 * @protected
		 */
		drawHalfTriangle : function( p1, p2, p3, lAdder, rAdder, lx, rx, colLeft, colRight, colLeftAdder, colRightAdder, surface ) // jshint ignore:line
		{
