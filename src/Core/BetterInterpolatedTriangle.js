...
define( [ 'Core/Point2D', 'Core/Color', 'Core/Line' ],

function( Point2D, Color, Line )
{
	'use strict';
	...
	var BetterInterpolatedTriangle = {
		 ...
		 */
		draw : function( p1, p2, p3, c1, c2, c3, surface )
		{
			this.p1.set( p1 );
			this.p2.set( p2 );
			this.p3.set( p3 );
		 ...
		 * @param {Surface} surface
		 */
		drawHalf : function( lineA, lineB, colLeft, colRight, colAdderLeft, colAdderRight, secondHalf, surface ) // jshint ignore:line
		{
	...
	return BetterInterpolatedTriangle;
} );
