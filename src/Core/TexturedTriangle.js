...
define( [ 'Core/Point2D', 'Core/Point3D', 'Core/Color', 'Core/Line', 'Core/Texture' ],

function( Point2D, Point3D, Color, Line /*, Texture*/ )
{
	'use strict';
	...
	return {
		...
		draw : function( p1, p2, p3, uv1, uv2, uv3, texture, surface ) // jshint ignore:line
		{
			this.p1.set( p1 );
			this.p2.set( p2 );
			this.p3.set( p3 );
		 ...
		 * @param {Surface} surface
		 */
		drawHalf : function( lineA, lineB, uvLeft, uvRight, uvAdderLeft, uvAdderRight, texture, secondHalf, uvLeftLength, uvRightLength, surface ) // jshint ignore:line
		{
